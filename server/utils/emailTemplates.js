        ...
        <tr>
          <td align="center">
            ...
            <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="background: linear-gradient(135deg, #dc2626, #b91c1c); padding:30px; text-align:center; color:#fff;">
                  <h1 style="margin:0; font-size:24px;">IBS Action Tracker</h1>
              ...
              <tr>
                <td style="padding:0 30px 30px;">
                  ...
                  <p style="font-size:14px; line-height:1.6;">
                    We received a request to reset your password for your <strong>IBS Action Tracker</strong> account.
                  </p>
                  ...
                  <p style="margin-top:30px; font-size:14px;">
                    Regards,<br/>
                    <strong>IBS Action Tracker Team</strong>
                  </p>
            ...
            <p style="font-size:12px; color:#999; margin-top:15px;">
              © ${new Date().getFullYear()} IBS Action Tracker. All rights reserved.
            </p>
            ...
            <table width="500" cellpadding="0" cellspacing="0" style="background:#ffffff; border-radius:10px; overflow:hidden; box-shadow:0 4px 10px rgba(0,0,0,0.08);">
              ...
              <tr>
                <td style="padding:0 30px 30px;">
                  ...
                  <p style="font-size:14px; line-height:1.6;">
                    Your password has been successfully reset for your <strong>IBS Action Tracker</strong> account.
                  </p>
