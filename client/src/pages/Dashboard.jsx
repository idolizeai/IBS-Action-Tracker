...
/>
      ...
      <motion.button
        ...
        className="fixed bottom-6 right-6 z-20 w-14 h-14 rounded-full bg-red-500 hover:bg-red-600 shadow-xl shadow-red-500/30 flex items-center justify-center text-white"
        title="Add task"
      >
